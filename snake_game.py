...
pygame.init()
font = pygame.font.Font('Montserrat-Medium.ttf', 25)
...
class SnakeGame:
    ...
    def _update_ui(self):
        ...
        pygame.draw.rect(self.display, FOOD_COLOUR, pygame.Rect(self.food.x, self.food.y, BLOCK_SIZE, BLOCK_SIZE), border_radius=2)
